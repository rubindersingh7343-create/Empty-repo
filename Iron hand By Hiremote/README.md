...
- **Iron Hand managers** push daily/weekly/monthly reports with attachments.
...
| Iron Hand | `ironhand@hiremote.com` | `operations123` | Upload daily/weekly/monthly reports |
...
- Iron Hand reporting interface covering daily recaps, weekly orders, and monthly packages.
...
- Responsive, branded UI with helpful microcopy for employees and managers.
...
- Layer on more granular permissions (multi-store clients, per-store reporting managers, etc.).
...
3. Send a daily/weekly/monthly report as the Iron Hand user.
